...
<main class="container">
	<section class="estaticos">
		...
		<p>El presente aviso legal regula los Términos y Condiciones de uso de la página web <?= $web;?> (en lo sucesivo, “el sitio web”), de la que es responsable <?= $conf_titular;?>, con CIF <?= $conf_cif;?> y dirección fiscal en <?= $conf_direccion;?>.</p>
		...
		<ul>
			<li>Internet Explorer - <a target="_blank" href="https://support.microsoft.com/es-es/windows/eliminar-y-administrar-cookies-168dab11-0753-043d-7c16-ede5947fc64d">Enlace</a></li>
			<li>Windows Phone - <a target="_blank" href="https://support.microsoft.com/es-es/windows/eliminar-y-administrar-cookies-168dab11-0753-043d-7c16-ede5947fc64d">Enlace</a></li>
			...
			<li>Blackberry - <a target="_blank" href="https://www.blackberry.com/us/en/legal/cookies">Enlace</a></li>
		</ul>
		<h3>Deshabilitar cookies de terceros</h3>
		<p>Puedes deshabilitar las cookies de Adobe Flash Player de terceros visitando el siguiente enlace:<br><a target="_blank" href="http://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash">http://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash</a></p>
